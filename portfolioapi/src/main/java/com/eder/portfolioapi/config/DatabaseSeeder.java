...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (repository.count() == 0) {
            ...
            Projeto p1 = new Projeto(); p1.setTitulo("Projeto CRUD em Java para aplicação Desktop"); p1.setDescricao("Aplicação desktop desenvolvida em Java com interface gráfica, permitindo a manipulação de dados em um banco de dados SQLite."); p1.setLinkGithub("https://github.com/JavaCrudSqlite"); p1.setTags(List.of("Java", "Swing", "MySQL")); projs.add(p1);
            Projeto p2 = new Projeto(); p2.setTitulo("Infraestrutura como Código (IaC) - Linux"); p2.setDescricao("Projeto de infra como código (IaC) para configuração de serviços e gerenciamento de usuários."); p2.setLinkGithub("https://github.com/linux-proj1-infra"); p2.setTags(List.of("Linux", "Shell Scripting", "Automação")); projs.add(p2);
            Projeto p3 = new Projeto(); p3.setTitulo("API RESTful - Sistema de E-commerce"); p3.setDescricao("API completa para gerenciamento de produtos, carrinho de compras e pedidos dos usuários."); p3.setLinkGithub("https://github.com/react-docker-yarn-typescript-2"); p3.setTags(List.of("Docker", "TypeScript", "React")); projs.add(p3);
            Projeto p4 = new Projeto(); p4.setTitulo("Aplicação Spring Boot com H2 Database"); p4.setDescricao("Aplicação desenvolvida com Spring Boot com padrão MVC"); p4.setLinkGithub("https://github.com/spring-rest-api-h2"); p4.setTags(List.of("Java", "Spring Boot", "MVC", "H2 Database")); projs.add(p4);
            Projeto p5 = new Projeto(); p5.setTitulo("Aplicação gestão de pessoas com HTML, CSS e JavaScript puros"); p5.setDescricao("Manipuação de dados de pessoas com HTML, CSS e JavaScript puros, utilizando LocalStorage MYSQL."); p5.setLinkGithub("https://github.com/CRUDTargetTrust"); p5.setTags(List.of("HTML", "Bootstrap", "PHP", "MySQL")); projs.add(p5);
            Projeto p6 = new Projeto(); p6.setTitulo("Blog em Angula no git pages sobre Silent Hill"); p6.setDescricao("Blog desenvolvido em Angular, hospedado no GitHub Pages, abordando informações e curiosidades sobre a franquia de jogos Silent Hill."); p6.setLinkGithub("https://github.com/angular-blog-jogos"); p6.setTags(List.of("Angular", "GitHub Pages", "Modular", "Routing")); projs.add(p6);
